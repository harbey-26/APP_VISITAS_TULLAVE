...
// El ASISTENTE solo consulta la agenda: toda mutación de visitas se bloquea
router.post('/', forbidAsistente, createVisit);
router.post('/cleanup-pending', requireAdmin, cleanupPendingVisits); // Depurar pendientes vencidas en bloque
router.patch('/:id', forbidAsistente, updateVisit);                          // Editar visita (dueño/admin)
