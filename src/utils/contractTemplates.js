        ...
        sections: [
                ...
                fields: [
                    {
                        ...
                        itemFields: [
                            ...
                            { key: 'conjunto', label: 'Conjunto / Edificio', type: 'text', hint: 'Opcional' },
            ...
            },
            {
                ...
                fields: [
                    ...
                    { key: 'garajes', label: 'Se arrienda con parqueadero(s) / garaje(s)', type: 'checkbox', default: false },
                    { key: 'numeroGarajes', label: 'Número de parqueadero(s) / garaje(s)', type: 'text', showIf: { key: 'garajes', equals: true }, hint: 'Ej.: 45, o "12 y 13" si son varios' },
                    { key: 'deposito', label: 'Se arrienda con depósito', type: 'checkbox', default: false },
                    { key: 'numeroDeposito', label: 'Número de depósito', type: 'text', showIf: { key: 'deposito', equals: true } },
