...
const fichaSchema = z.object({
    ...
    arrendatarioTipoPersona: z.string().trim().max(30).optional().nullable(),
...
function serializeIncremento(inc, indices, hoy = hoyISO()) {
    ...
    if (!snapshot) {
        ...
        snapshot = {
            ...
            arrendatarioTipoPersona: ficha?.arrendatarioTipoPersona || '',
...
export function fichaDesdeContrato(contract) {
    ...
    return {
        ...
        arrendatarioTipoPersona: d.arrendatarioTipoPersona || null,
