...
import { Calendar as CalIcon, CheckCircle2, XCircle, AlertTriangle, ExternalLink, Loader2 } from 'lucide-react';
            ...
            <Card>
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            {loading
                                ...
                                : !status?.enabled
                                    ...
                                    : status.broken
                                        ? <Badge className="bg-red-100 text-red-700"><AlertTriangle className="w-3 h-3 inline" />Requiere reconectar</Badge>
                                        : status.connected
                        ...
                        {!loading && status?.broken && (
                            <p className="text-xs text-red-800 bg-red-50 border border-red-200 rounded-lg p-3 mb-3">
                                <b>La integración está caída.</b> {status.problema}
                                <br />
                                Mientras tanto NO salen: correos de respuesta a solicitudes, contratos,
                                liquidaciones, cartas de incremento ni el código de acceso del Portal de
                                Clientes; tampoco se sincroniza el calendario.
                            </p>
                        )}
